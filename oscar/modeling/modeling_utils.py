...
class CaptionPreTrainedModel(BertPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, prompt_sid, **kwargs):
        return {"input_ids": input_ids, "prompt_sid": prompt_sid}
    ...
    def _decode_step(self, input_ids, past):
        model_inputs = self.prepare_inputs_for_generation(input_ids, prompt_sid, past=past)
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            ...
            if cur_len == 1:
                ...
                assert cur_len > 1
                if not self._do_output_past(outputs): # 问题出在这
